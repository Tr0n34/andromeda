package fr.andromeda.cyb.configurations.swagger;
...
public class SwaggerConfiguration {
    ...
    private void applyServers(io.swagger.v3.oas.models.OpenAPI openApi) {
    ...
    private void addHeadersToComponents(io.swagger.v3.oas.models.OpenAPI openApi) {
